...
<html>
  <head>
    ...
    <meta name='description' content='Advanced Power of PHP - using ApPHP DataGrid Pro for displaying some statistical data, with aggregation function' />
...
<?php
    ...
    ##  ***      "barchart" : number format in SELECT SQL must be equal with number format in max_value
     $vm_columns = array(
        ...
        "population"   =>array("header"=>"Population",       "type"=>"label", "summarize"=>true, 'summarize_function'=>'AVG', "align"=>"right",  "wrap"=>"nowrap", "text_length"=>"-1", "case"=>"normal", 'on_item_created'=>'setColor'),
    ...
    function setColor($field_value){
        if(strlen($field_value) > 6){
            return '<span style="color:green">'.$field_value.'</span>';
        }elseif(strlen($field_value) > 5){
             return '<span style="color:blue">'.$field_value.'</span>';
        }else{
            return '<span style="color:gray">'.$field_value.'</span>';
        }
    }
